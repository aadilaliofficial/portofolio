        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <p className="text-xl mb-4" style={{ color: '#9199A6' }}>
              Full-stack Developer and open-source enthusiast passionate about building scalable solutions, robust microservices, and clean, intuitive user interfaces. I focus on creating products that solve real-world problems—projects with genuine utility, not just portfolio pieces.
            </p>
            <p className="text-lg" style={{ color: '#9199A6' }}>
              Currently working at InfoTechBrains CloudTech Pvt Ltd, where I leverage Next.js, Prisma, MERN Stack and cloud to design and implement microservice-driven architectures for mutual fund platforms. When I’m not coding, you’ll find me exploring new places or immersed in a good book.
            </p>
          </motion.div>
