  ...
  useEffect(() => {
    async function fetchGitHubData() {
      ...
      try {
        ...
        const reposRes = await fetch('https://api.github.com/users/aadilaliofficial/repos?type=public&sort=updated&per_page=10');
          ...
          <div className="max-w-4xl mx-auto space-y-20">
            ...
            >
              ...
              <div className="flex justify-center gap-8">
                <a
                  href="https://github.com/aadilaliofficial"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.linkedin.com/in/aadilalideveloper/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center gap-3 hover:text-white transition-all duration-300"
                >
                ...
                <a
                  href="https://twitter.com/aadilalitank"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center gap-3 hover:text-white transition-all duration-300"
                >
